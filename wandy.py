...
def MoveMotor() :
    ...
    pi.set_servo_pulsewidth(4, 1200) # safe clockwise
    time.sleep(timeToSleep)
    pi.set_servo_pulsewidth(4, 1500) # safe anti-clockwise
...
def Spell(spell):
    ...
    if (spell=="center"):
        print ("I am triggering your motor")
        MoveMotor()
    elif (spell=="circle") or (spell=="square"):
